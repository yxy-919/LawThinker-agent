...
class Lawyer_generation(LawThinker):
    ...
    async def speak_with_thinker(self, content, case_id, turn, semaphore, save_to_memory=True):
        ...
        response_prompt = get_response_prompt_report(new_seq['system_prompt'], new_seq['output'], document_type="起诉状")
...
@register_class(alias="Agent.Lawyer.GPT_CD")
...
@register_class(alias="Agent.Lawyer.Qwen3_14B_CD")
...
@register_class(alias="Agent.Lawyer.Qwen3_8B_CD")
...
@register_class(alias="Agent.Lawyer.Qwen3_32B_CD")
...
@register_class(alias="Agent.Lawyer.GLM9B_CD")
...
@register_class(alias="Agent.Lawyer.Chatlaw2_CD")
...
@register_class(alias="Agent.Lawyer.LawLLM_CD")
...
@register_class(alias="Agent.Lawyer.Deepseekv3_CD")
...
@register_class(alias="Agent.Lawyer.GenerationLLaMa3_3complaint")
...
@register_class(alias="Agent.Lawyer.InternLM3_CD")
...
@register_class(alias="Agent.Lawyer.Ministral8B_CD")
